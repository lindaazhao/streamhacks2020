...
while not done and start == 1:
    ...
    if binvelocityx >= -0.9 and binvelocityx <= 0.9: #Velocity decays if already cloe to 0
        binvelocityx = 0
    ...
    if wasteSpawnTimer == 120:
      newWaste = Waste(1, random.randint(250, 655), 0, 2, 35, 35)
      waste_list.append(newWaste)
      wasteSpawnTimer = 0
    ...
    tracker = font.render(str(score), 1, BLACK)
    screen.blit(tracker, (900, 500))
